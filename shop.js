document.addEventListener('DOMContentLoaded', function() {
    ...
    if (selectedToy && products[selectedToy]) {
      ...
      document.getElementById('img1').style.backgroundImage = `url(${products[selectedToy].side1})`;
      document.getElementById('img2').style.backgroundImage = `url(${products[selectedToy].side2})`;
      document.getElementById('img3').style.backgroundImage = `url(${products[selectedToy].side3})`;
    }
  });
  ...
  function switchThree() {
    const selectedToy = localStorage.getItem('selectedToy');
    document.getElementById("mainimg").src = products[selectedToy].side3;
  }